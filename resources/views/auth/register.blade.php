    ...
    <div class="flex justify-center min-h-screen">
        ...
        <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
            ...
            <a href="#" class="mx-auto ">
                ...
                <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2" action="{{route('registeration')}}" method="post" >
                    @csrf
                    <div>
                        <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200"> UserName</label>
                        <input type="text" name="name" placeholder="John" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
