...
<div class="w-full max-w-sm p-6 m-auto mx-auto rounded-lg shadow-md bg-gray-800">
    ...
    <form class="mt-6" action="{{route('loging')}}" method="post">
        @csrf
        <div>
    ...
    <p class="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? <a href="{{route('register')}}" class="font-medium text-gray-700 dark:text-gray-200 hover:underline">Create One</a></p>
</div>
</main>
</body>
</html>
